...
TEMPLATES[0]["DIRS"] = [location("../demo/templates")] + TEMPLATES[0][  # noqa: F405
    "DIRS"
]
...
] + INSTALLED_APPS  # noqa: F405  # noqa: F405
...
CUSTOM_SORTIDES_INSTRUCCIONS_PAGAMENT = (
    "Paga com puguis, no s'ha especificat res de res"
)
CUSTOM_SORTIDES_INSTRUCCIONS_PAGAMENT_ENTITAT_BANCARIA = """El pagament s'ha de realitzar fent ingrés en el número de compte de l'Institut Thos i Codina"""
...
CUSTOM_SORTIDES_INSTRUCCIONS_PAGAMENT_ONLINE = """El pagament s'ha de realitzar, amb targeta Mastercard o VISA, a través d'aquesta mateixa plataforma.\
...
CUSTOM_MESSAGE_BENVINGUDA_FAMILIES = [
    ...
    "Benvolgut/da,",
    "",
    "El motiu d'aquest correu és el de donar-vos les instruccions d'alta de l'aplicació Djau del nostre centre.",
    "Aquesta aplicació us permetrà fer un seguiment diari del rendiment acadèmic del vostre fill/a.",
    "Per tant, hi trobareu les faltes d'assistència, de disciplina, les observacions del professorat , les sortides que afectaran al vostre fill/a entre altres informacions.",
    "",
    "Per a donar-vos d'alta:",
    "",
    " * Entreu a {0} on podeu obtenir o recuperar les claus d'accés a l'aplicació.".format(
        URL_DJANGO_AULA
    ),
    " * Cliqueu l'enllaç 'Obtenir o recuperar accés'. ",
    " * Escriviu la vostra adreça de correu electrònic.",
    " * Cliqueu el botó  Enviar.",
    " * Consulteu el vostre correu electrònic on hi trobareu un missatge amb les instruccions per completar el procés d'accés al Djau.",
    "",
    "Com bé sabeu és molt important que hi hagi una comunicació molt fluida entre el centre i les famílies.",
    "És per això que us recomanem que us doneu d'alta a aquesta aplicació i per qualsevol dubte que tingueu al respecte, poseu-vos en contacte amb el tutor/a del vostre fill/a.",
    "",
