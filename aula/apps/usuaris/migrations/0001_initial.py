...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=2,
                        choices=[
                            (b"PL", b"Passar llista"),
                            (b"LL", b"Posar o treure alumnes a la llista"),
                            (b"IN", b"Posar o treur Incid\xc3\xa8ncia"),
                            (b"EE", b"Editar Expulsi\xc3\xb3"),
                            (b"EC", b"Expulsar del Centre"),
                            (b"RE", b"Recullir expulsi\xc3\xb3"),
                            (b"AC", b"Registre Actuaci\xc3\xb3"),
                            (b"AG", b"Actualitza alumnes des de Saga"),
                            (b"MT", b"Envia missatge a tutors"),
                            (b"SK", b"Sincronitza Kronowin"),
                            (b"JF", b"Justificar Faltes"),
                            (b"NF", b"Notificacio Families"),
                        ],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "abstractonetimepasswd_ptr",
                    models.OneToOneField(
                        parent_link=True,
                        auto_created=True,
                        primary_key=True,
                        serialize=False,
                        to="usuaris.AbstractOneTimePasswd",
