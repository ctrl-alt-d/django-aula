...
from aula.apps.matricula.views import (
    ActivaMatricula,
    Confirma,
    LlistaMatConf,
    LlistaMatFinals,
...
urlpatterns = [
    path(
        "confirma/<int:nany>/", Confirma, name="relacio_families__matricula__confirma"
    ),
    ...
    path(
        "matricula/<int:curs>/<int:nany>/<tipus>/",
        LlistaMatFinals,
        name="gestio__matricula__llistat",
    ),
    path(
        "matricula/<int:pk>/<int:curs>/<int:nany>/<tipus>/",
        VerificaConfirma,
        name="gestio__matricula__llistat",
    ),
