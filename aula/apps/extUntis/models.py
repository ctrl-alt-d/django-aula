...
class Agrupament(models.Model):
    grup_alumnes = models.ForeignKey(
        Grup, related_name="grup_alumnes", on_delete=models.CASCADE
    )
    grup_horari = models.ForeignKey(
        Grup, related_name="grup_horari", on_delete=models.CASCADE
    )
