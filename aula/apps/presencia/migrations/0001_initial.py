    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="100=Falta tota l'hora, 0=No \xe9s falta assist\xe8ncia. Aquest camp serveix per que els retrassos es puguin comptar com a falta o com un percentatge de falta.",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "horari",
                    models.ForeignKey(to="horaris.Horari", on_delete=models.CASCADE),
                ),
                (
                    "professor_guardia",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                to="presencia.EstatControlAssistencia",
                null=True,
                on_delete=models.CASCADE,
            ),
        ),
        ...
        migrations.AddField(
            ...
            name="professor",
            field=models.ForeignKey(
                blank=True, to="usuaris.Professor", null=True, on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="controlassistencia",
