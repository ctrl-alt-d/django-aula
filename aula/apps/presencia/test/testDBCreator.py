...
class TestDBCreator(object):
    ...
    def __init__(self):
        ...
        diaSetmanaAhir = DiaDeLaSetmana.objects.create(
            n_dia_uk=diaAnteriorUK,
            n_dia_ca=diaAnterior,
            dia_2_lletres=diesSetmana2Lletres[diaAnterior],
            dia_de_la_setmana=diesSetmana[diaAnterior],
            es_festiu=False,
        )
        diaSetmanaAbansAhir = DiaDeLaSetmana.objects.create(
            n_dia_uk=dosDiesAbansUK,
            n_dia_ca=dosDiesAbans,
            dia_2_lletres=diesSetmana2Lletres[dosDiesAbans],
            dia_de_la_setmana=diesSetmana[dosDiesAbans],
            es_festiu=False,
        )
        ...
        sistemesDAM = Assignatura.objects.create(
            nom_assignatura="Sistemes", curs=primerDAM, tipus_assignatura=tipusAssigUF
        )
