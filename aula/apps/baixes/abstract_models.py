...
class AbstractFeina(models.Model):
    ...
    professor_fa_guardia = models.ForeignKey( 'usuaris.Professor' , blank=True, null=True, related_name="feina_professor_guardia_set", help_text = u"Professor que farà la guàrdia.")
    ...
    professor_darrera_modificacio = models.ForeignKey( to = 'usuaris.Professor', related_name="feina_professor_audit_set", )
