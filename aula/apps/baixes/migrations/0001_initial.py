    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('impartir', models.OneToOneField(to='presencia.Impartir')),
                ('professor_darrera_modificacio', models.ForeignKey(related_name='feina_professor_audit_set', to='usuaris.Professor')),
                ('professor_fa_guardia', models.ForeignKey(related_name='feina_professor_guardia_set', blank=True, to='usuaris.Professor', help_text='Professor que far\xe0 la gu\xe0rdia.', null=True)),
            ],
            options={
