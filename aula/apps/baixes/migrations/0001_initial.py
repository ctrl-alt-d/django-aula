        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        help_text="Comentaris per al professor que fa la gu\xe0rdia, guardia que substitueix en cas necessari.",
                        blank=True,
                    ),
                ),
                ...
                (
                    ...
                    models.OneToOneField(
                        to="presencia.Impartir", on_delete=models.CASCADE
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        blank=True,
                        to="usuaris.Professor",
                        help_text="Professor que far\xe0 la gu\xe0rdia.",
                        null=True,
                        on_delete=models.CASCADE,
                    ),
                ),
