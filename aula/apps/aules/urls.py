...
urlpatterns = [
    re_path(
        r"^lesMevesReservesDAula/$",
        aula_views.reservaAulaList,
        name="gestio__reserva_aula__list",
    ),
    # wizard per aula
    re_path(
        r"^consultaAulaPerAula/$",
        aula_views.consultaAulaPerAula,
        name="gestio__reserva_aula__consulta",
    ),
    re_path(
        r"^detallAulaReserves/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/(?P<pk>\d+)/$",
        aula_views.detallAulaReserves,
        name="gestio__reserva_aula__detallaulareserves",
    ),
    # wizard per franja
    re_path(
        r"^consultaAulaPerFranja/$",
        aula_views.consultaAulaPerFranja,
        name="gestio__reserva_aula__consulta",
    ),
    re_path(
