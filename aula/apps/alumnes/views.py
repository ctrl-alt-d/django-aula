...
# forms
from aula.apps.alumnes.forms import triaMultiplesAlumnesForm, triaAlumneSelect2Form
...
def elsMeusAlumnesAndAssignatures(request):
    ...
    for (
        ...
        nClasses = Impartir.objects.filter(
...
def llistaAlumnescsv(request):
    ...
    dades = [
        [
            ...
            (
                bool(e.correu_relacio_familia_pare)
                or bool(e.correu_relacio_familia_mare)
            ),
        ]
