    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                choices=[(False, "No notificar."), (True, "Notificar-les totes.")],
                default=True,
        ...
        migrations.AlterField(
            ...
            name="nom_curs",
            field=models.CharField(
                help_text="Un número que representa el curs (Ex: 3)",
                max_length=45,
                verbose_name="Nom curs",
            ),
        ),
        migrations.AlterField(
            model_name="nivell",
            name="nom_nivell",
            field=models.CharField(
                max_length=45, unique=True, verbose_name="Nom nivell"
            ),
        ),
    ]
