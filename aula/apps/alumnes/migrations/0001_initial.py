            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=3,
                        choices=[
                            (b"PRC", b"En proc\xc3\xa9s de sincronitzaci\xc3\xb3"),
                            (b"S-I", b"Sincronitzat Insert"),
                            (b"S-U", b"Sincronitzat Update"),
                            (b"DEL", b"Alumne donat de baixa"),
                            (b"MAN", b"Alumne donat d'alta manualment"),
                        ],
                    ),
                ),
                ...
                (
                    ...
                    models.EmailField(
                        ...
                        max_length=254,
                        verbose_name="1r Correu Notifi. Tutors",
                        blank=True,
                    ),
                ),
                (
                    ...
                    models.EmailField(
                        ...
                        max_length=254,
                        verbose_name="2n Correu Notifi. Tutors",
                        blank=True,
                    ),
                ),
                ...
                (
                    "telefons",
                    models.CharField(db_index=True, max_length=250, blank=True),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        default=3,
                        help_text="Interval de temps m\xednim entre dues notificacions",
                        choices=[
                            (0, b"No notificar"),
                            (1, b"Un dia"),
                            (2, b"Dos dies"),
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Periodicitat en la notificaci\xf3 de les incid\xe8ncies.",
                        choices=[
                            (False, b"No notificar."),
                            (True, b"Notificar-les totes."),
                        ],
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nom_curs",
                    models.CharField(
                        help_text="Un n\xfamero que representa el curs (Ex: 3)",
                        max_length=45,
                        verbose_name=b"Nom curs",
                    ),
                ),
                (
                    "nom_curs_complert",
                ...
                (
                    "data_inici_curs",
                    models.DateField(
                        help_text="Dia que comencen les classes (cal informar aquest cap per poder fer control de pres\xe8ncia)",
                        null=True,
                        verbose_name=b"Comencen",
                        blank=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nom_grup",
                    models.CharField(
                        help_text="Aix\xf2 normalment ser\xe0 una lletra. Ex 'A' ",
                        max_length=45,
                    ),
                ),
                ...
                (
                    "curs",
                    models.ForeignKey(to="alumnes.Curs", on_delete=models.CASCADE),
                ),
            ],
            options={
                "ordering": [
                    "curs",
                    "curs__nivell__nom_nivell",
                    "curs__nom_curs",
                    "nom_grup",
                ],
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nom_nivell",
                    models.CharField(
                        unique=True, max_length=45, verbose_name=b"Nom nivell"
                    ),
                ),
                (
                    "ordre_nivell",
