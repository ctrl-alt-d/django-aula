...
def reportLlistaTutorsIndividualitzats():
    TutorIndividualitzat.objects.all().values_list("pk")
    ...
    capcelera.contingut = "{0}".format("Professor")
    taula.capceleres.append(capcelera)

    capcelera = tools.classebuida()
    capcelera.amplade = 50
    capcelera.contingut = "{0}".format("Alumnes amb tutoria individualitzada")
    taula.capceleres.append(capcelera)

    capcelera = tools.classebuida()
    capcelera.amplade = 20
    capcelera.contingut = "{0}".format("Accions")
    taula.capceleres.append(capcelera)
    ...
    for tutor in Professor.objects.all():
        ...
        camp.contingut = unicode("Gestiona Alumnes")
        filera.append(camp)
