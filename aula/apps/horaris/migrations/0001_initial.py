        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        unique=True,
                        verbose_name="N\xfamero de dia de la setmana a UK (0=diumenge)",
                    ),
                ),
                (
                    "n_dia_ca",
                    models.IntegerField(
                        unique=True,
                        verbose_name="N\xfamero de dia de la setmana aqu\xed (0=dilluns)",
                    ),
                ),
                (
                    "dia_2_lletres",
                    models.CharField(unique=True, max_length=6, verbose_name=b"Dia"),
                ),
                (
                    "dia_de_la_setmana",
                    models.CharField(
                        unique=True, max_length=45, verbose_name=b"Dia de la setmana"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dia_de_la_setmana",
                    models.ForeignKey(
                        to="horaris.DiaDeLaSetmana", on_delete=models.CASCADE
                    ),
                ),
                (
                    "grup",
                ...
                (
                    "hora",
                    models.ForeignKey(
                        to="horaris.FranjaHoraria", on_delete=models.CASCADE
                    ),
                ),
                (
                    "professor",
