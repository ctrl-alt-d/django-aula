    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        help_text="Data i Hora de l'actuaci\xf3. Format: 2011-06-01 9:05"
                    ),
                ),
                (
                    "qui_fa_actuacio",
                    models.CharField(
                        help_text="Qui realitza l'actuaci\xf3",
                        max_length=1,
                        choices=[
                            (b"T", "Tutor"),
                            (b"C", "Cap d'estudis"),
                ...
                (
                    "amb_qui_es_actuacio",
                    models.CharField(
                        help_text="Sobre qui es realitza l'actuaci\xf3",
                        max_length=1,
                        choices=[
                            (b"A", "alumnes.Alumne"),
                            (b"F", "Familia"),
                ...
                (
                    "actuacio",
                    models.TextField(
                        help_text="Explicaci\xf3 detallada de l'actuaci\xf3 realitzada. No inclogueu dades m\xe8diques ni diagn\xf2stiques.",
                        blank=True,
                    ),
                ),
                (
                    "alumne",
                    models.ForeignKey(
                        help_text="Alumne sobre el qual es fa l'actuaci\xf3",
                        to="alumnes.Alumne",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "carta_numero",
                    models.IntegerField(
                        verbose_name="Av\xeds n\xfamero", editable=False
                    ),
                ),
                ...
                (
                    "faltes_fins_a_data",
                    models.DateField(
                        verbose_name=b"Faltes fins a data", editable=False
                    ),
                ),
                ...
                (
                    "faltes_incloses",
                    models.TextField(
                        verbose_name=b"Faltes incloses a la carta",
                        editable=False,
                        blank=True,
                    ),
                ),
                ...
                (
                    "nfaltes",
                    models.IntegerField(
                        verbose_name="Abs\xe8ncies injustificades", editable=False
                    ),
                ),
                ...
                (
                    "professor",
                    models.ForeignKey(
                        verbose_name=b"Professor que signa la carta",
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        null=True, to="alumnes.Alumne", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "professorQueInforma",
                    models.CharField(default=b"", max_length=200, blank=True),
                ),
                (
                    "seguiment_tutorial",
                    models.ForeignKey(
                        to="tutoria.SeguimentTutorial", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "grup",
                    models.ForeignKey(to="alumnes.Grup", on_delete=models.CASCADE),
                ),
                (
                    "professor",
                    models.ForeignKey(to="usuaris.Professor", on_delete=models.CASCADE),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.AlterUniqueTogether(
            name="seguimenttutorialrespostes",
            unique_together=set(
                [("seguiment_tutorial", "any_curs_academic", "pregunta")]
            ),
        ),
        migrations.AlterUniqueTogether(
            name="seguimenttutorial",
