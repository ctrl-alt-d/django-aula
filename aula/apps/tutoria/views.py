...
def detallTutoriaAlumne( request, pk , detall = 'all'):
    ...
    if detall in ['all','dades']:
        ...
        capcelera = tools.classebuida()
        capcelera.amplade = 15
        capcelera.contingut = u'Dades Responsable 1 (Principal)'
        capcelera.enllac = ""
        taula.capceleres.append(capcelera)
        ...
        camp = tools.classebuida()
        camp.enllac = None
        camp.contingut = u'{0}'.format(alumne.rp1_nom) if alumne.primer_responsable == 1 else u'{0}'.format(alumne.rp2_nom)
        filera.append(camp)
        ...
        camp.enllac = None
        telefons = ', '.join(
            filter(None, [alumne.rp1_telefon, alumne.rp1_mobil])) if alumne.primer_responsable == 1 else '/ '.join(
        ...
        camp = tools.classebuida()
        camp.enllac = None
        camp.contingut = u'{0}'.format(alumne.rp1_correu) if alumne.primer_responsable == 1 else u'{0}'.format(alumne.rp2_correu)
        filera.append(camp)
        ...
        camp = tools.classebuida()
        camp.enllac = None
        camp.contingut = u'{0}'.format(alumne.rp2_nom) if alumne.primer_responsable == 1 else u'{0}'.format(alumne.rp1_nom)
        filera.append(camp)
        ...
        camp.enllac = None
        telefons = ', '.join(
            filter(None, [alumne.rp2_telefon, alumne.rp2_mobil])) if alumne.primer_responsable == 1 else '/ '.join(
        ...
        camp = tools.classebuida()
        camp.enllac = None
        camp.contingut = u'{0}'.format(alumne.rp2_correu) if alumne.primer_responsable == 1 else u'{0}'.format(alumne.rp1_correu)
        filera.append(camp)
