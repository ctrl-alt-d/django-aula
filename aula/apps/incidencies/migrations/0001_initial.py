    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alumne', models.ForeignKey(help_text="Alumne al qual s'expulsa", to='alumnes.Alumne')),
                ('control_assistencia', models.ForeignKey(blank=True, to='presencia.ControlAssistencia', null=True)),
                ('franja_expulsio', models.ForeignKey(help_text="Franja en que l'alumne ha estat expulsat", to='horaris.FranjaHoraria')),
                ('professor', models.ForeignKey(blank=True, to='usuaris.Professor', help_text='Professor que expulsa', null=True)),
                ('professor_recull', models.ForeignKey(related_name='expulsions_recollides', to='usuaris.Professor', help_text="Professor que recull l'expulsi\xf3")),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relacio_familia_revisada', models.DateTimeField(null=True)),
                ('relacio_familia_notificada', models.DateTimeField(null=True)),
                ('alumne', models.ForeignKey(help_text='Alumne al qual li posem la incid\xe8ncia', to='alumnes.Alumne')),
                ('control_assistencia', models.ForeignKey(blank=True, to='presencia.ControlAssistencia', null=True)),
                ('franja_incidencia', models.ForeignKey(help_text='Moment en que es va produir la incid\xe8ncia', to='horaris.FranjaHoraria')),
                ('professional', models.ForeignKey(help_text='Professor que tramita la incid\xe8ncia', to='usuaris.Professional')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relacio_familia_revisada', models.DateTimeField(null=True)),
                ('relacio_familia_notificada', models.DateTimeField(null=True)),
                ('alumne', models.ForeignKey(help_text='Alumne sancionat', to='alumnes.Alumne')),
                ('franja_fi', models.ForeignKey(related_name='hora_fi_sancio', to='horaris.FranjaHoraria', help_text='Darrera hora de sanci\xf3')),
                ('franja_inici', models.ForeignKey(related_name='hora_inici_sancio', to='horaris.FranjaHoraria', help_text='Primera hora de sanci\xf3')),
                ('professor', models.ForeignKey(help_text='Professor que tramita la sanci\xf3', to='usuaris.Professor')),
            ],
            options={
                'ordering': ['alumne'],
                'abstract': False,
