...
from aula.apps.alumnes.forms import (
    ...
    triaAlumneNomSentitSelect2Form,
)
...
def editaExpulsio(request, pk):
    ...
    telefonResponsable1 = (
        expulsio.alumne.rp1_telefon if expulsio.alumne.rp1_telefon else ""
    )
    telefonResponsable2 = (
        expulsio.alumne.rp2_telefon if expulsio.alumne.rp2_telefon else ""
    )
    ...
    infoResponsable1 = nomResponsable1 + (
        " (" + " , ".join(filter(None, [telefonResponsable1, mobilResponsable1])) + ")"
    )
    infoResponsable2 = nomResponsable2 + (
        " (" + " , ".join(filter(None, [telefonResponsable2, mobilResponsable2])) + ")"
    )
    responsable1 = (
        infoResponsable1
        if expulsio.alumne.primer_responsable == 0
        else infoResponsable2
    )
    responsable2 = (
        infoResponsable2
        if expulsio.alumne.primer_responsable == 0
        else infoResponsable1
    )
