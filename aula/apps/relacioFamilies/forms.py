...
class AlumneModelForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["primer_responsable"] = forms.ChoiceField(
            choices=responsable_choices
        )
        self.fields["primer_responsable"].help_text = (
            "Principal responsable de l'alumne/a"
        )
...
class comunicatForm(forms.Form):
    ...
    def clean(self):
        ...
        if motiu == "A" and not observ:
            self.add_error(
                "observacions", "Si \"Altres\", s'ha d'explicar a observacions"
            )
