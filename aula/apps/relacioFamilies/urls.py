...
urlpatterns = [
    re_path(
        r"^elMeuInforme/$",
        relacioFamilies_views.elMeuInforme,
        name="relacio_families__informe__el_meu_informe",
    ),
    re_path(
        r"^dadesRelacioFamilies/$",
        relacioFamilies_views.dadesRelacioFamilies,
        name="tutoria__relacio_families__dades_relacio_families",
    ),
    re_path(
        r"^configuraConnexio/(?P<pk>\d+)/$",
        relacioFamilies_views.configuraConnexio,
    ...
    re_path(
        r"^enviaBenvinguda/(?P<pk>\d+)/$",
        relacioFamilies_views.enviaBenvinguda,
        name="tutoria__relacio_families__envia_benvinguda",
    ),
    re_path(
        r"^elMeuInforme/(?P<pk>\d+)/$",
        relacioFamilies_views.elMeuInforme,
        name="relacio_families__informe__el_meu_informe",
    ),
    re_path(
    ...
    path(
        "blanc/",
        relacioFamilies_views.blanc,
        name="relacio_families__comunicats__blanc",
    ),
    path(
        "comunicat/",
        relacioFamilies_views.comunicatAbsencia,
        name="relacio_families__comunicats__absencia",
    ),
    path(
        "anteriors/",
        relacioFamilies_views.comunicatsAnteriors,
        name="relacio_families__comunicats__anteriors",
    ),
    path(
        "horesAlumneAjax/<idalumne>/<dia>/",
        relacioFamilies_views.horesAlumneAjax,
        name="relacio_families__horesAlumneAjax",
    ),
    path(
        "canviaAlumne/<idalumne>/",
        relacioFamilies_views.canviaAlumne,
        name="relacio_families__canviaAlumne",
    ),
    path(
        "escollirAlumne/",
        relacioFamilies_views.escollirAlumne,
        name="relacio_families__escollirAlumne",
    ),
]
