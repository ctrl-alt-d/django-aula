...
class ToDo(models.Model):
    ...
    tasca = models.CharField(max_length=100, help_text="Tasca a realitzar")
    informacio_adicional = models.TextField(
        "Informació adicional", help_text="Informació adicional"
    )
