...
class PreinscripcioForm(forms.Form):
    fitxer_Preinscripcio = forms.FileField(
        required=True, label="Fitxer de la preinscripció"
    )
    resetPrevious = forms.BooleanField(
        label="Elimina dades anteriors",
        required=False,
        help_text="S'esborren preinscripcions pendents, d'activació de matrícula, dels mateixos \
