 ...
 #"08_TELÈFON RESP. 1","09_TELÈFON RESP. 2","10_RESPONSABLE 2","11_RESPONSABLE 1"
    ...
    for row in reader:
        ...
        if alumneDadesAnteriors is None:
            ...
            # no se li canviarà de grup en les importacions de Esfer@.
...
def comprovar_grups( f ):
    ...
    for row in reader:
        ...
        if new:
            errors.append( u"El grup '{grup_classe}' del Esfer@ no té correspondència al programa. Revisa les correspondències Esfer@-Aula".format( grup_classe=grup_classe ) )
