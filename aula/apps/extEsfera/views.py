...
from aula.apps.extEsfera.forms import dadesAddicionalsForm, sincronitzaEsferaForm
...
def dadesAddicionals(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(
                request,
                "resultat.html",
                {"head": "Resultat importació dades addicionals", "msgs": resultat},
            )
    else:
    ...
    return render(
        ...
        {"form": form, "camps_addicionals": camps_addicionals},
    )
