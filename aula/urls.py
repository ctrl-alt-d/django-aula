...
from aula.apps.alumnes.views import (
    llistaGrupsPromocionar,
    mostraGrupPromocionar,
    nouAlumnePromocionar,
)
from aula.utils.views import keepalive, logout_page, menu
...
urlpatterns = [
    re_path(
        r"^api-token-auth/", TokenObtainPairView.as_view(), name="token_obtain_pair"
    ),
    ...
    re_path(
        r"^promocions/(?P<grup>\d+)/$",
        mostraGrupPromocionar,
        name="administracio__promocions__grups",
    ),
    re_path(
        r"^promocions/nou-alumne",
        nouAlumnePromocionar,
        name="administracio__alumnes__noualumne",
    ),
    re_path(
        r"^promocions/",
        llistaGrupsPromocionar,
        name="administracio__promocions__llista",
    ),
    re_path(
        r"^presencia/",
        include(
            "aula.apps.presencia.urls",
        ),
    ),
