...
class initDBForm(forms.Form):
    confirma = forms.BooleanField(
        label="Confirma inicialització",
        required=True,
        help_text="Inicialitza la base de dades. Fa logout de tots els usuaris. Aquest procés no es pot desfer.\
    ...
    def clean_confirma(self):
        ...
        if not data:
            raise forms.ValidationError(
                "Confirma la inicialització de la base de dades"
            )
